...
export function UserProfile() {
  ...
  const handleIsNewChange = (isNew: boolean) => {
    if (!localProfile) return;
    setLocalProfile((prev) => ({ ...prev!, isNew }));
  };
  ...
  const handleResetAccount = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "All of your posts and reels have been deleted.",
      });
      setIsEditing(false);
    } catch (error) {
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1">
                ...
                <Textarea
                  ...
                  name="bio"
                  value={
                    Array.isArray(localProfile.bio)
                      ? localProfile.bio.join("\n")
                      : ""
                  }
              ...
              <div className="space-y-1">
                ...
                <div className="flex gap-2">
                  <Input
                    id="posts"
                    name="posts"
                    value={localProfile.stats.posts}
                  ...
                  <Input
                    id="followers"
                    name="followers"
                    value={localProfile.stats.followers}
                    onChange={handleStatsChange}
                  ...
                  <Input
                    id="following"
                    name="following"
                    value={localProfile.stats.following}
                    onChange={handleStatsChange}
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        ...
                        delete all your posts and reels. Your profile
            ...
            <div className="max-w-4xl mx-auto">
              <div className="p-4">
                  ...
                  <div className="flex-1 flex justify-around items-center">
                    <div className="text-center">
                      <div className="font-bold text-base sm:text-lg">
                        {formatStat(localProfile.stats.posts)}
                      </div>
                    ...
                    <div className="text-center">
                      <div className="font-bold text-base sm:text-lg">
                        {formatStat(localProfile.stats.followers)}
                      </div>
                      <div className="text-xs sm:text-sm text-zinc-400">
                        followers
                      </div>
                    ...
                    <div className="text-center">
                      <div className="font-bold text-base sm:text-lg">
                        {formatStat(localProfile.stats.following)}
                      </div>
                      <div className="text-xs sm:text-sm text-zinc-400">
                        following
                      </div>
                ...
                <div className="mb-4 space-y-1">
                  ...
                  {Array.isArray(localProfile.bio) && (
                    <BioWithMentions bio={localProfile.bio} />
                  )}
                  {localProfile.link && (
                    <a
                      href={`https://${localProfile.link}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-2 text-xs sm:text-sm text-blue-400"
                    >
                      <Link2 size={16} />
                ...
                >
                  <div>
                    ...
                    <div className="flex items-center gap-1 text-xs text-zinc-400">
                      ...
                      <span>
                        {formatNumber(localProfile.stats.totalViews || 0)} views
                        in the last 30 days
                      </span>
                    </div>
                  </div>
              ...
              <div className="profile-tabs">
                <button onClick={() => setActiveTab("grid")}>
                  <svg
                    className={`tab-icon ${activeTab === "grid" ? "active" : ""}`}
                    viewBox="0 0 24 24"
                  >
                    <rect
                      x="3"
                ...
                <button onClick={() => setActiveTab("tagged")}>
                  <svg
                    className={`tab-icon ${activeTab === "tagged" ? "active" : ""}`}
                    viewBox="0 0 24 24"
                    fill="none"
                    stroke="currentColor"
                    strokeWidth="2"
